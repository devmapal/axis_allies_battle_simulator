...
public class HitOrderFragment extends ListFragment {
    ...
    public static HitOrderFragment newInstance(int headers, int footers) {
        HitOrderFragment f = new HitOrderFragment();
    ...
    public List<String> get_hit_order() {
        return list;
    }

    public interface Constants {
        String LOG = "foss.devmapal.axis_allies_calc.axis_allies_calc.HitOrderFragment";
    }
}
